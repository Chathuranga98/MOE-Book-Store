...
function AnnouncementSchool() {
    const schoolUserName =  Cookies.get('username');

    const [allAnnouncements,setAllAnnouncements] = useState([])
    useEffect(() => {
        axios.get("http://localhost:5000/announcement/allAnnouncementForSchool/"+schoolUserName)
    ...
    function ViewAnnouncement( _id,title, description, message, divisional_office, school,createdAt){
        ...
        window.location.href = "/ViewAnnouncement";
    }
...
export default AnnouncementSchool;