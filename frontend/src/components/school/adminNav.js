                ...
                <nav class="navbar navbar-expand-lg navbar-light shadow-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" style={{fontSize:'17px'}} href="/School/School_Dash"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Home </a>
                            </li>
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="School_Announcements"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> View Announcements </a>
                            </li> 
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="CurrentBookList"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Available Books </a>
                            </li>
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="Request_book_from_deo"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Requests Books from DEO </a>
                            </li>
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="Request_book_from_school"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Requests Books from School </a>
                            </li>
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="ManageAccount"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Manage Account </a>
                            </li>
                            <li class="nav-item " >
