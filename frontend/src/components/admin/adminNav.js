...
const NavLinks = [
    ...
    },
    {
      id: 4,
      item: "Book Requests",
      link:'Admin_BookRequest'
    },
    {
      id:5,
      item: "Educational Divisional Offices",
      link:'DivisionalOffice'
    },
    {
      id:6,
      item: "Subject",
                        ...
                        <li className="nav-item dropdown nav-user">
                            ...
                            <div className="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div className="nav-user-info">
                                    <h5 className="mb-0 text-white nav-user-name text-capitalize">Admin</h5>
                        ...
                        <ul className="navbar-nav flex-column">
                           ...
                           {NavLinks.map((nav) => (
                                <li className="nav-item ">
                                    <a className="nav-link " style={{fontSize:'17px'}} href={nav.link}  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1">{nav.item}</a>
                                </li>
                           ))}
                        </ul>
                    </div>
