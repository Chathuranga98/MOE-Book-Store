                ...
                <nav class="navbar navbar-expand-lg navbar-light shadow-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="DEO_school"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Schools </a>
                            </li> 
                            <li class="nav-item " >
                                <a class="nav-link " style={{fontSize:'17px'}} href="DEO_bookRequest"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"> Bookshop  Requests </a>
                            </li>
                            <li class="nav-item " >
