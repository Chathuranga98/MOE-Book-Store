...
const NavLinks = [
    {
      id: 1,
      item: "Dashboard",
      link : "Bookshop_dashboard"
    },
    {
      id: 2,
      item: "Books Request",
      link : "Bookshop_book_request"
    },
    {
      id: 3,
      item: "Book Store",
                        ...
                        <li className="nav-item dropdown nav-user">
                            ...
                            <div className="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div className="nav-user-info">
                                    <h5 className="mb-0 text-white nav-user-name text-capitalize">BOOKSHOP</h5>
                        ...
                        <ul className="navbar-nav flex-column">
                           ...
                           {NavLinks.map((item) => (
                                <li className="nav-item ">
                                    <a className="nav-link " style={{fontSize:'17px'}} href={item.link}  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1">{item.item}</a>
                                </li>
                           ))}
                        </ul>
                    </div>
